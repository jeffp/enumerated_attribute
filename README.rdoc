...
When subclassing an ActiveRecord model class, do not forget to set the table_name.

class SuperUser < User
	set_table_name "users"
end

Do not user write_attribute to write an enumerated attribute, such as 
write_attribute(:gender, :male).  Use the accessors, [], update_attribute, attribute or attributes methods.
